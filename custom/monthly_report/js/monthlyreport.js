...
function addNospecial( ){
	 //alert("BBBB");
	
	
	 var onevalue=Number(jQuery("#edit-onebonevalue").val());

	
	 var twovalue=Number(jQuery("#edit-onebtwovalue").val());

	 var threevalue=Number(jQuery("#edit-onebthreevalue").val());
	 
	 var fourvalue=Number(jQuery("#edit-onebfourvalue").val());
	 

	// var fivevalue=Number(jQuery("#edit-gffiveb").val());
	 // alert(fivevalue);
	 var sixvalue=Number(jQuery("#edit-onebfivevalue").val());

	 var sevenvalue=Number(jQuery("#edit-twobvalue").val());


	  var eightvalue=Number(jQuery("#edit-threebvalue").val());
	  var ninevalue=Number(jQuery("#edit-fourbvalue").val());
	  var tenvalue=Number(jQuery("#edit-fivebvalue").val());
	  var elevenvalue=Number(jQuery("#edit-sixbvalue").val());


	  var twelevevalue=Number(jQuery("#edit-sevenbvalue").val());
	  var thirteenvalue=Number(jQuery("#edit-eightbvalue").val());
	  var fourteenvalue=Number(jQuery("#edit-ninebvalue").val());
	  var fifthteenvalue=Number(jQuery("#edit-tenbvalue").val());

	  var sixteenvalue=Number(jQuery("#edit-elevanbvalue").val());

	  var seventeenvalue=Number(jQuery("#edit-twelevebvalue").val());
	  //var sixteenvalue=Number(jQuery("#edit-thirteenbvalue").val());
	
	   
	
 
  var gftotal=onevalue  + twovalue +  threevalue + fourvalue  + sixvalue + sevenvalue + eightvalue + ninevalue + tenvalue 
  + elevenvalue +  twelevevalue + thirteenvalue + fourteenvalue + fifthteenvalue + sixteenvalue +  seventeenvalue; 
   //alert("ssss"+gftotal);
  //document.getElementById("edit-Gfeight").value=Gfone  ; 
 
  //alert("ssss"+gfone);
   jQuery("#edit-thirteenbvalue").val(gftotal);
