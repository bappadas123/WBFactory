	...
	if(array_key_exists(4, $user->roles)){
		...
		if(!empty($userData)){
			...
			if(array_key_exists(7, $user->roles)){
				...
				$role = 'Deputy Director (Chemical)';
			}elseif(array_key_exists(14, $user->roles)){
				$role = 'Director (Chemical)';
			}elseif(array_key_exists(17, $user->roles)){
				$role = 'Joint Director (Chemical)';
...
<div class="wrapper">
	<div class="menu-wrapper">
        ...
        <?php   if(array_key_exists(4, $user->roles) != 4){ ?>
        	<div class="navbar nav-bg top-nav" role="navigation">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            foreach($nav_menu as $val){
                                ...
                                if(!$val['link']['hidden']){
                                    ...
                                    if($link =='<front>' || $link =='aboutus' || $link =='contact-us'|| $link =='rti'|| $link =='faq' || $link =='approval-of-plan'){
                                        $hide ='none';
                                    }else{
                                        $hide ='';
                                    }
                                    ...
                                    if($val['link']['has_children']){ ?>
                                        ...
                                        <li class="dropdown user user-menu"><a href="<?php print $base_root.$base_path.$link;?>" class="dropdown-toggle" data-toggle="dropdown"><?php print $val['link']['link_title']?><b class="caret"></b></a>
                                    <?php
                                            ...
                                            if(!empty($val['below'])){?>
                                                ...
                                                if(!$level2['link']['hidden']){
                                                    ...
                                                    <li class="user-footer">
                                                        <a  target="_blank" href="<?php print $base_root.$base_path.$level2_path;?>"><?php print $level2['link']['link_title'];?></a>
                                                    </li>
                                                    <?php }
                                                    }?>
                                                </ul>  
...
<?php } ?>
        	...
        	<div class="navbar nav-bg" role="navigation">
   				<div class="navbar-header">
            		<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                		<span class="sr-only">Toggle navigation</span>
                		<span class="icon-bar"></span>
   				...
   				<div class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav">
                        <?php 
                                ...
                                foreach($nav_menu as $val){
                                    if(!$val['link']['hidden']){
                                        ...
                                        if($val['link']['has_children']){?>
                                            ...
                                            <li><a href="<?php print $base_root.$base_path.$link;?>" class="dropdown-toggle" data-toggle="dropdown"><span><?php print $val['link']['link_title']?></span><b class="caret"></b></a>
                                                ...
                                                <?php foreach($val['below'] as $level2){?>
                                                    <li class="dropdown-submenu">
                                                        ...
                                                        ?>
                                                            ...
                                                            <a href="<?php print $base_root.$base_path.$level2_path;?>" class="dropdown-toggle" ><span><?php print $level2['link']['link_title'];?></span><b class="caret"></b></a>   
                                        ...
                                        <?php }else{?>	
                                                ...
                                                <li class="<?php echo $active_class;?>"> <a href="<?php print $base_root.$base_path.$link;?>"><span><?php print $val['link']['link_title']?></span> </a> </li>
                                ...
                                foreach($nav_menu as $val){
                                    if(!$val['link']['hidden']){
                                        ...
                                        if($val['link']['has_children']){?>
                                            ...
                                            <li><a href="<?php print $base_root.$base_path.$link;?>" class="dropdown-toggle menu-md" data-toggle="dropdown"><span><?php print $val['link']['link_title']?></span><b class="caret"></b></a>
                                        ...
                                        <?php }else{?>	
                                                ...
                                                <li class="<?php echo $active_class;?>"> <a href="<?php print $base_root.$base_path.$link;?>" class="menu-md"><span><?php print $val['link']['link_title']?></span> </a> </li>
                            ...
                            <?php 
                               if (($user->uid!=0) && array_key_exists(12, $user->roles)) {
                                $nav_menu = menu_tree_all_data('menu-chief-menu');
                                foreach($nav_menu as $val){
                                    if(!$val['link']['hidden']){
                                        $link = drupal_get_path_alias($val['link']['link_path']);
                                ...
                                foreach($nav_menu as $val){
                                    if(!$val['link']['hidden']){
                                        ...
                                        <?php }else{?>	
                                                ...
                                                <li class="<?php echo $active_class;?>"> <a href="<?php print $base_root.$base_path.$link;?>"><?php print $val['link']['link_title']?></span> </a> </li>
                            ...
                            <?php 
                                ...
                                <?php 
                                   if (($user->uid!=0) && array_key_exists(24, $user->roles)) {
                                    $nav_menu = menu_tree_all_data('menu-statistician-menu');
                                foreach($nav_menu as $val){
                                    if(!$val['link']['hidden']){
                                        $link = drupal_get_path_alias($val['link']['link_path']);
        ...
        <div class="pull-right right-panel-div">
        	<div class="user-prof-div">
        	<div class="media">
                <div class="media-left">
                  <img src=<?php print $base_root.$base_path.'sites/all/themes/custom_dashboard/images/user-edit.png'?> alt="" class="media-object"/>
                </div>
                <div class="media-body">
                  <p class="media-heading"><span class="text-danger"><?php print $fname;?></span></p>
                  <p><?php print $mail_id;?></p>
                  <p><?php print $role;?></p>
                  <hr />
                </div>
            </div>
            <?php if($role!='Applicant'){?>
                <a href="<?php print $base_root.$base_path.'profileupdate'?>" class="btn btn-danger pull-left">Profile</a>
            <?php }?>
            <a href="<?php print $base_root.$base_path.'user/logout'?>" class="btn btn-success pull-right">Sign out</a>
          </div>
				...
				?>
					...
					<?php if($link_arr[1] == "inspector-plan"){?>
						...
						<li class="<?php if($link_arr[2] == 'factory-caf-information'){ echo 'active';}?>">
							<?php echo l('CAF Information', '/admin/inspector-plan/factory-caf-information/'.$link_arr[3].'/'.$link_arr[4].'/'.$link_arr[5].'/'.$link_arr[6]);?>
						</li>
                    ...
                    <?php if($link_arr[1] == "inspector-bklog-plan"){?>
						...
						<li class="<?php if($link_arr[2] == 'bklog-factory-caf-information'){ echo 'active';}?>">
							<?php echo l('CAF Information', '/admin/inspector-bklog-plan/bklog-factory-caf-information/'.$link_arr[3].'/'.$link_arr[4].'/'.$link_arr[5].'/'.$link_arr[6]);?>
						</li>
					...
					<?php if($link_arr[1] == "deputy-plan"){?>
						...
						<li class="<?php if($link_arr[2] == 'factory-caf-information-dd'){ echo 'active';}?>">
							<?php echo l('CAF Information', '/admin/deputy-plan/factory-caf-information-dd/'.$link_arr[3].'/'.$link_arr[4].'/'.$link_arr[5].'/'.$link_arr[6]);?>
						</li>
                    ...
                    <?php if($link_arr[1] == "deputy-bklog-plan"){?>
						...
						<li class="<?php if($link_arr[2] == 'bklog-factory-caf-information-dd'){ echo 'active';}?>">
							<?php echo l('CAF Information', '/admin/deputy-bklog-plan/bklog-factory-caf-information-dd/'.$link_arr[3].'/'.$link_arr[4].'/'.$link_arr[5].'/'.$link_arr[6]);?>
						</li>
					...
					<?php if($link_arr[1] == "joint-plan"){?>
                        ...
                        <li class="<?php if($link_arr[2] == 'factory-caf-information-jd'){ echo 'active';}?>">
                            <?php echo l('CAF Information', '/admin/joint-plan/factory-caf-information-jd/'.$link_arr[3].'/'.$link_arr[4].'/'.$link_arr[5].'/'.$link_arr[6]);?>
                        </li>
                    ...
                    <?php if($link_arr[1] == "joint-bklog-plan"){?>
                        ...
                        <li class="<?php if($link_arr[2] == 'bklog-factory-caf-information-jd'){ echo 'active';}?>">
                            <?php echo l('CAF Information', '/admin/joint-bklog-plan/bklog-factory-caf-information-jd/'.$link_arr[3].'/'.$link_arr[4].'/'.$link_arr[5].'/'.$link_arr[6]);?>
                        </li>
                    ...
                    <?php if($link_arr[1] == "inspector-chemical-plan"){?>
						...
						<li class="<?php if($link_arr[2] == 'factory-caf-information-adch'){ echo 'active';}?>">
							<?php echo l('CAF Information', '/admin/inspector-chemical-plan/factory-caf-information-adch/'.$link_arr[3].'/'.$link_arr[4].'/'.$link_arr[5].'/'.$link_arr[6]);?>
						</li>
					...
					<?php if($link_arr[1] == "deputy-chemical-plan"){?>
						...
						<li class="<?php if($link_arr[2] == 'factory-caf-information-ddch'){ echo 'active';}?>">
							<?php echo l('CAF Information', '/admin/deputy-chemical-plan/factory-caf-information-ddch/'.$link_arr[3].'/'.$link_arr[4].'/'.$link_arr[5].'/'.$link_arr[6]);?>
						</li>
					...
					<?php if($link_arr[1] == "joint-chemical-plan"){?>
                        ...
                        <li class="<?php if($link_arr[2] == 'factory-caf-information-jdch'){ echo 'active';}?>">
                            <?php echo l('CAF Information', '/admin/joint-chemical-plan/factory-caf-information-jdch/'.$link_arr[3].'/'.$link_arr[4].'/'.$link_arr[5].'/'.$link_arr[6]);?>
                        </li>
        ...
        <!--for e-note registartion----------start-->
    				...
    				?>
      				...
      				<?php if($link_arr[1] == "jdregistration"){?>
							...
							<?php echo l('Basic Information', '/admin/jdregistration/view-register-factory-information-jd/'.$link_arr[3].'/'.$link_arr[4].'/'.$link_arr[5].'/'.$link_arr[6]);?>
                        </li>
					  ...
					  <?php if($link_arr[1] == "inspectorrenewal"){?>
									...
									<li class="<?php if($link_arr[2] == 'view-renewal-inspector'){ echo 'active';}?>">
										<?php echo l('CAF Information', '/admin/inspectorrenewal/view-renewal-inspector/'.$link_arr[3].'/'.$link_arr[4].'/'.$link_arr[5].'/'.$link_arr[6]);?>
									</li>
							...
							<?php if($link_arr[1] == "deputyrenewal"){?>
								...
								<li class="<?php if($link_arr[2] == 'view-renewal-deputy'){ echo 'active';}?>">
									<?php echo l('CAF Information', '/admin/deputyrenewal/view-renewal-deputy/'.$link_arr[3].'/'.$link_arr[4].'/'.$link_arr[5].'/'.$link_arr[6]);?>
								</li>
							...
							<?php if($link_arr[1] == "inspectoramendment"){?>
								...
								<li class="<?php if($link_arr[2] == 'view-amendment-inspector'){ echo 'active';}?>">
									<?php echo l('CAF Information', '/admin/inspectoramendment/view-amendment-inspector/'.$link_arr[3].'/'.$link_arr[4].'/'.$link_arr[5].'/'.$link_arr[6]);?>
								</li>
								...
								<?php if($link_arr[1] == "deputyamendment"){?>
									...
									<li class="<?php if($link_arr[2] == 'view-amendment-deputy'){ echo 'active';}?>">
										<?php echo l('CAF Information', '/admin/deputyamendment/view-amendment-deputy/'.$link_arr[3].'/'.$link_arr[4].'/'.$link_arr[5].'/'.$link_arr[6]);?>
									</li>
	...
	<!--for inspection report end-->
		...
		<?php
			...
			<li class="<?php if($link_arr[2] == 'view-amendment-inspector' || $link_arr[2] == ''){ echo 'active';}?>">
				<?php  echo l('CAF Information', '/admin/inspectortransfer-back/view-amendment-inspector/'.$link_arr[3].'/'.$link_arr[4].'/'.$link_arr[5].'/'.$link_arr[6]);?>
			</li>
...
<?php
			...
			<li class="<?php if($link_arr[2] == 'view-transfer-deputy' || $link_arr[2] == ''){ echo 'active';}?>">
				<?php  echo l('CAF Information', '/admin/deputytransfer-back/view-transfer-deputy/'.$link_arr[3].'/'.$link_arr[4].'/'.$link_arr[5].'/'.$link_arr[6]);?>
			</li>
                 ...
                 if($link_arr[1] == "monthly-report"){
                    ...
                    elseif(array_key_exists(15, $user->roles)) {
                      ...
                      <li class="<?php if($link_arr[2] == '' || $link_arr[2] == 'step1'){ echo 'active';}?>">
                        ...
                        <li class="<?php if($link_arr[2] == 'step16'){ echo 'active';}?>">
                            <?php  echo l('STEP8', '/admin/monthly-report/step16/'.$link_arr[3]);?>
                        </li>
                 ...
                 <?php
                    ...
                    <li class="<?php if($link_arr[2] == '' || $link_arr[2] == 'step1'){ echo 'active';}?>">
                        ...
                        <li class="<?php if($link_arr[2] == 'step14'){ echo 'active';}?>">
                         ...
                         <li class="<?php if($link_arr[2] == 'step16'){ echo 'active';}?>">
                            <?php  echo l('STEP15', '/admin/monthly-report/step16/'.$link_arr[3]);?>
                        </li>
